          ...
          <div class="col-md-12">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">个人详细信息</h3>
              </div>
              <form class="form-horizontal" id="display_exist" style="display: block;">
                ...
                <div class="box-footer" style="text-align: center;">
                  <button type="button" class="btn btn-primary" id="modify_info">点击修改</button>
                </div>
              </form>
              
              <form class="form-horizontal" style="display: none;" id="display_modify">
                <div class="form-group">
                  <label  class="col-sm-3 control-label" style="padding-top: 7px;text-align: right;">姓名:</label>
                  <div class="col-sm-5">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-5" style="padding-top: 6px;">
                    <label>
                        <input type="radio" class="minimal" name="sex"  >
                      男
                    </label>
                ...
                <div class="form-group">
                  <label  class="col-sm-3 control-label" style="padding-top: 7px;text-align: right;">头像:</label>
                  <div class="col-sm-5">
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-5">
                   <select class="form-control">
                      <option>请选择</option>
                      <c:forEach items="${identifyList}" var="item">
                        <option value="${item.name}"><c:out value="${item.name}"></c:out></option>
                      </c:forEach>
                    </select>
                  </div>
                ...
                <div class="form-group" >
                  ...
                  <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control pull-right" id="birthday" name="">
                    </div>
                  </div>
                </div>
                 <div class="form-group" >
                 ...
                 <div class="form-group" >
                  ...
                  <div class="col-sm-5">
                    <select class="form-control">
                      <option>请选择</option>
                      <c:forEach items="${academicList}" var="item">
                        <option value="${item.name}"><c:out value="${item.name}"></c:out></option>
                      </c:forEach>
                    </select>
                  </div>
                 ...
                 <div class="form-group" >
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="entranceAge" name="entranceAge">
                    </div>
                  </div>
                </div>
                 <div class="form-group" >
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="graduteAge" name="graduteAge">
                    </div>
                  </div>
                </div>
                 <div class="form-group" >
                 ...
                 <div class="form-group" >
                  ...
                  <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control pull-right" id="inductive" name="inductive">
                    </div>
                  </div>
                </div>
                 <div class="form-group" >
                 ...
                 <div class="form-group" >
                  ...
                  <div class="col-sm-5">
                    <select class="form-control">
                      <option>请选择</option>
                      <c:forEach items="${natureList}" var="item">
                        <option value="${item.name}"><c:out value="${item.name}"></c:out></option>
                      </c:forEach>
                    </select>
                  </div>
                ...
                <div class="box-footer" style="text-align: center;">
                  <button type="submit" class="btn btn-primary" id="re_save">保存</button>
                  <button type="button" class="btn btn-primary" style="margin-left: 70px" id="check_info">查看个人信息</button>
                </div>
              </form>
            </div>
          </div>
