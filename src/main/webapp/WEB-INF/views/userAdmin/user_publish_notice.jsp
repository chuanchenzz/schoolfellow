                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" id="inputTitle"
                                                                  name="notice_title" placeholder="this is title"></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">通知类型:</label>
                                    <div class="col-sm-10"><select class="form-control" name="noticeType">
                                        <option value="1">通知消息</option>
                                        <option value="2">校友消息</option>
