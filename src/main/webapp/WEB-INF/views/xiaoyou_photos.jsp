          ...
          <div class="col-md-9">
            <div class="box box-danger">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right"><span class="label label-danger">总共8位成员</span></div>
              </div>
              <div class="box-body no-padding">
                <ul class="users-list clearfix">
                  <li><img src="../../AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image"><a href="#" class="users-list-name">ChuanChen</a></li>
                  <li><img src="../../AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image"><a href="#" class="users-list-name">ChuanChen</a></li>
                  <li><img src="../../AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image"><a href="#" class="users-list-name">ChuanChen</a></li>
                  <li><img src="../../AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image"><a href="#" class="users-list-name">ChuanChen</a></li>
                  <li><img src="../../AdminLTE-2.3.11/dist/img/user1-128x128.jpg" alt="User Image"><a href="#" class="users-list-name">ChuanChen</a></li>
